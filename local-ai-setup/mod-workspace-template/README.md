...
1. Make sure Cline is wired up: API Provider = `Ollama`, Model = `qwen2.5-coder:7b`.
...
- **Switch models** for hard tasks: gear icon → Model dropdown → `qwen3-coder:30b-a3b-q4_K_M` (if installed) or `deepseek-r1:14b`.
