...
For tougher errors, switch to a stronger model first: in the Cline chat panel, click the gear → Model dropdown → pick `qwen3-coder:30b-a3b-q4_K_M` (if you downloaded it) or `deepseek-r1:14b` (better at chain-of-thought reasoning).
...
| Model | When to use |
|---|---|
| `qwen2.5-coder:7b` | Default — fast, fine for 90% of pose-pack work |
| `qwen3-coder:30b-a3b-q4_K_M` | Big refactors across 5+ files; new mod scaffolding |
