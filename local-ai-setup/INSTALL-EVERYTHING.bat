@echo off
title CP2077 Local AI -- Installer (v4.3)
setlocal EnableDelayedExpansion
cd /d "%~dp0"

REM ============================================================
REM   CP2077 Local AI -- Easy Mode Installer (v4.3)
REM ============================================================
REM   v4.3 BUG-FIX RELEASE:
REM     - Fixes 'pull model manifest: file does not exist' errors
REM       that stopped v4.2 from downloading any coder model. Root
REM       cause: qwen3-coder:7b does not exist on Ollama (no 7B
REM       variant is published), and qwen3-coder:30b-a3b needs the
REM       explicit quantization suffix :30b-a3b-q4_K_M. v4.3 pulls
REM       qwen2.5-coder:7b (baseline) and qwen3-coder:30b-a3b-q4_K_M
REM       (optional bigger), both of which actually exist.
REM     - VERIFY-INSTALL.bat smoke test now accepts either family.
REM
REM   Still true from v4.2:
...
echo CP2077 Local AI Installer v4.3 - %DATE% %TIME% > "%LOGFILE%"
echo Working dir: %CD% >> "%LOGFILE%"

cls
echo.
echo ============================================================
echo   CP2077 Local AI -- Easy Mode Installer (v4.3)
echo ============================================================
echo.
...
echo     3. Then it downloads the AI model (~4.7 GB) -- the
